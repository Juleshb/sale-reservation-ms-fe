           ...
           >
            ...
            <ul className="md:flex-col text-base font-medium leading-normal md:min-w-full text-primary dark:text-gray-200 flex flex-col list-none">
              <li className={"font-semibold items-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 hover:text-white hover:bg-primary dark:hover:bg-gray-700 px-4 rounded-lg " +
                ...
                <Link className={"text-xs flex py-3 block"} to="/admin">
              ...
              <li className={"font-semibold items-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 hover:text-white hover:bg-primary dark:hover:bg-gray-700 px-4 rounded-lg " +
                ...
                <Link className="text-xs flex py-3 block" to="/healthcare">
                  <Icon icon="fluent:branch-request-20-filled" className="mr-2 text-sm" />
                  Requested Reservation
                </Link>
              </li>

              <li className={"font-semibold items-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 hover:text-white hover:bg-primary dark:hover:bg-gray-700 px-4 rounded-lg " +
                   (window.location.href.indexOf("/my-reservations") !== -1 
                     ? "translate-y-1 scale-110 duration-300 text-white bg-primary dark:bg-gray-700"
                     : "")
                     }>
                <Link className="text-xs flex py-3 block" to="/my-reservations">
              ...
              <li className={"font-semibold items-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 hover:text-white hover:bg-primary dark:hover:bg-gray-700 px-4 rounded-lg " +
                 ...
                 <Link className="text-xs flex py-3 block" to="/room">
                  <Icon icon="iconoir:house-rooms" className="mr-2 text-sm"/>
                  Rooms
                </Link>
              </li>
              ...
              <li className={"font-semibold items-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 hover:text-white hover:bg-primary dark:hover:bg-gray-700 px-4 rounded-lg " +
                ...
                <Link className="text-xs flex py-3 block" to="/users">
                  <Icon icon="ph:users-three-thin" className="mr-2 text-sm" />
                  Users
                </Link>
              </li>

              <li className="font-semibold items-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 hover:text-white hover:bg-primary dark:hover:bg-gray-700 px-4 rounded-lg">
                <Link className="text-xs flex py-3 block" to="/auth/register">
                  <Icon icon="bx:book" className="mr-2 text-sm" />
                  Report
                </Link>
              </li>
            </ul>
